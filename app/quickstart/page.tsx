	...
	step: [
		{
			...
			text:
				"Upload 20-50 images for your LORA training dataset. Supports JPG and PNG formats up to 10MB.",
			position: 1,
		},
		{
			"@type": "HowToStep",
			...
			text:
				"Select enhancement options: upscale for quality, uncrop for better composition, or convert to square format.",
			position: 2,
		},
		{
			"@type": "HowToStep",
			...
			text:
				"Get your processed images ready for LORA training, optimized for best results.",
			position: 3,
		},
	],
	tool: [
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
							...
							<p className="text-gray-600 dark:text-gray-300 text-sm">
								Drag and drop or select your image file. We support JPG and PNG formats
								up to 10MB.
							</p>
						</div>
						<div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
							...
							<p className="text-gray-600 dark:text-gray-300 text-sm">
								Select your desired enhancement options and adjustments for the perfect
								result.
							</p>
						</div>
						<div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
							...
							<p className="text-gray-600 dark:text-gray-300 text-sm">
								Get your enhanced image instantly and download in your preferred format.
							</p>
						</div>
					</div>
				</div>
