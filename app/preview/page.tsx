      ...
      `}
		>
          ...
          `}
            ...
            border-0 
            bg-white text-gray-900
            dark:bg-[#141414] dark:text-gray-100 dark:backdrop-blur-sm
          `}
				>
					<CardContent className="p-0">
                            ...
                            `}
													>
														<div className="flex items-center gap-2">
															<Badge
																variant="outline"
																className="px-3 py-1 text-sm bg-none text-white"
															>
																파일 {index + 1}
															</Badge>
															...
															<div key={method.id} className="space-y-3">
																<div className="flex items-center space-x-3">
																	<Checkbox
																		...
																		onCheckedChange={() => handleMethodToggle(index, method.id)}
																		...
																		>
																			...
																			>
																				{[
																					...
																					// 예상 해상도 계산
																					let expectedWidth = fileItem.dimensions
																						? fileItem.dimensions.width
																						: 0;
																					let expectedHeight = fileItem.dimensions
																					...
																					return (
																						...
																						>
																							...
																							>
																								...
																								<span
																									className={`font-bold ${
																										exceedsMax ? "text-yellow-500" : "text-blue-500"
																									}`}
																								>
																									{exceedsMax
																										? "Maximum"
						...
						<div className="mt-8 flex justify-end gap-4">
							...
							<button
								...
								disabled={
									isUploading || !files.every((file) => file.processingOption !== null)
								}
