        ...
        >
          ...
          >
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            className={
                              exceedsMax ? 'text-yellow-500' : 'text-blue-400'
                            }
                          >
                            {exceedsMax
                              ? 'Maximum'
            ...
            {fileItem.processingOption?.method === 'square' && (
              <div className="space-y-2">
                <RadioGroup
                  value={fileItem.processingOption.targetRes || '2048'}
                  onValueChange={(value: string) =>
                    onSquareTargetResChange(
                      index,
                      value as '1024' | '1568' | '2048'
                    )
                  }
                  className="space-y-2"
                >
                  {[
                    ...
                    >
                      <RadioGroupItem
                        value={option.value}
                        id={`square-${option.value}-${index}`}
                        className="border-indigo-600 text-indigo-600"
                      />
                      <label
                        htmlFor={`square-${option.value}-${index}`}
                        className="text-sm text-gray-300"
                      >
                        {option.label}
                      </label>
